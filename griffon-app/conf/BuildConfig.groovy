...
deploy {
    application {
        title = 'GriffonStats 0.1'
        vendor = System.properties['user.name']
        homepage = 'http://localhost/GriffonStats'
        description {
            complete = 'GriffonStats 0.1'
            oneline  = 'GriffonStats 0.1'
            minimal  = 'GriffonStats 0.1'
            tooltip  = 'GriffonStats 0.1'
        }
        icon {
            fallback {
...
app.fileType = '.groovy'
app.defaultPackageName = 'statsclient'
